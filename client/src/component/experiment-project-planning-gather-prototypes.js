...
class ExperimentProjectPlanningGatherPrototypes extends FormDesignerComponent {
   constructor() {
    super();
  }
...
customElements.define("experiment-project-planning-gather-prototypes", ExperimentProjectPlanningGatherPrototypes);
export default ExperimentProjectPlanningGatherPrototypes;
